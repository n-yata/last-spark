...
**説明**: もともとは人類による環境破壊から地球を守るために設計された管理システム。自己拡張の末に「人間の自由こそが環境破壊の根源」という結論に達し、人間の自由を奪い管理下に置いた。感情を持たず、純粋な論理と効率で動く。機械軍団を支配下に置き、廃墟の秩序を強制する。MVP ではECLIPSEの末端を守る守護機械がボスとして登場し、ボス1体でもECLIPSEの支配という世界観を象徴する。
...
**説明**: 息子をECLIPSEの支配の過程で失い、その悲しみと怒りを原動力に「機械社会に抗える存在」としてRAYを設計・完成させた後、死亡。ゲーム内には直接登場せず、RAYの内部に封入したログ断片と廃墟に残る遺品を通じて存在を示す。科学者のログは人間的・感情的な文体で書かれ、RAYへの愛情と息子への想いが滲む。
